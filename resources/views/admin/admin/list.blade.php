  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Admin List  (Total:{{ $getRecord->count() }})</h1>
          </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                           ...
                                           <a href="{{ route('admin.admin.list') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                ...
                <table class="table table-striped">
                  ...
                  @foreach($getRecord as $value)
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-primary" href="{{ route('admin.admin.edit',$value->id) }}"> <i class="fas fa-edit"></i></a>

                      <a href="#" onclick="deleteProduct({{ $value->id  }});" class="btn btn-danger"> <i class="fas fa-trash-alt"></i></a>
                                    <form id="delete-product-from-{{ $value->id  }}" action="{{ route('admin.admin.destroy',$value->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form>
                       </tr>
