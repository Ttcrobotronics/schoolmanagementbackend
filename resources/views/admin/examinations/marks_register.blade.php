                            ...
                            <div class="card-body">
                                <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" id="class" name="exam_id" required>
                                    ...
                                    <div class="form-group col-md-3">
                                           ...
                                           <a href="{{ route('admin.examinations.marks_register') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                     ...
                     <tr>
                       ...
                       $getMark = $subject->getMark($student->id,Request::get('exam_id'),Request::get('class_id'),$subject->subject_id);
                        ...
                        <td>
                         ...
                         Class Work
                         <input type="hidden" class="form-control" name="mark[{{ $i }}][id]" value="{{$subject->id}}">
                         <input type="hidden" class="form-control" name="mark[{{ $i }}][subject_id]" value="{{$subject->subject_id}}">
                         <input type="text" class="form-control" value="{{!empty($getMark->class_work) ? $getMark->class_work : ''}}" name="mark[{{ $i }}][class_work]" style="width:200px;" placeholder="Enter Marks" id="class_work_{{$student->id}}{{$subject->subject_id}}">
                         </div>

                          <div style="margin-bottom:10px">
                         Home Work
                         <input type="text" class="form-control" value="{{!empty($getMark->home_work) ? $getMark->home_work : ''}}" name="mark[{{ $i }}][home_work]" style="width:200px;" placeholder="Enter Marks" id="home_work_{{$student->id}}{{$subject->subject_id}}">
                         </div>

                         <div style="margin-bottom:10px">
                         Test Work
                         <input type="text" class="form-control" value="{{!empty($getMark->test_work) ? $getMark->test_work : ''}}" name="mark[{{ $i }}][test_work]" style="width:200px;" placeholder="Enter Marks" id="test_work_{{$student->id}}{{$subject->subject_id}}">
                         </div>

                         <div style="margin-bottom:10px">
                         Exam 
                         <input type="text" class="form-control" value="{{!empty($getMark->exam) ? $getMark->exam : ''}}" name="mark[{{ $i }}][exam]" style="width:200px;" placeholder="Enter Marks" id="exam_{{$student->id}}{{$subject->subject_id}}">
                         </div>
