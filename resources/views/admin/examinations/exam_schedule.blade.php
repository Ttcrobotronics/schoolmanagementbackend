                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                           ...
                                           <a href="{{ route('admin.examinations.exam_schedule') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            @if(!empty($getRecord))
            <form action="{{ route('admin.examinations.exam_schedule_insert') }}" method="post">
    {{ csrf_field() }}
