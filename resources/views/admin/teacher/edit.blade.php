                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="admission_date" placeholder="Enter Admission Date" name="admission_date" value="{{ old('admission_date', $getRecord->admission_date) }}" required >
                                ...
                                <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="note" placeholder="Enter Note" name="note">{{ old('note', $getRecord->note) }}</textarea>
