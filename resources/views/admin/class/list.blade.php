                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                           ...
                                           <a href="{{ route('admin.class.list') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                ...
                <table class="table table-striped">
                  ...
                  @foreach($getRecord as $value)
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-primary" href="{{ route('admin.class.edit',$value->id) }}"> <i class="fas fa-edit"></i></a>

                      <a href="#"  onclick="deleteProduct({{ $value->id  }});"  class="btn btn-danger"> <i class="fas fa-trash-alt"></i></a>
                      <form id="delete-product-from-{{ $value->id  }}" action="{{ route('admin.class.destroy',$value->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form>        
                       </tr>
