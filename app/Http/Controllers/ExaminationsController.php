...
// 
    ...
    public function exam_insert(Request $request)
    {
        ...
        $exam->save();
        return redirect()->route('admin.examinations.exam.list')->with('success', 'Exam Successfully Created.');
    }
    ...
    public function exam_update($id,Request $request)
    {
        ...
        $exam->save();
        return redirect()->route('admin.examinations.exam.list')->with('success', 'Exam Successfully Updated.');
    }
...
else
{
    ...
    $save->created_by = Auth::user()->id;
            ...
            $save->subject_id = $mark['subject_id']; // Change to get subject_id from $mark
...
else
{
    ...
    {
        $json['message'] = "Mark Register Successfully Saved. Some Subject Mark Greater Then Full Mark";
    }
   ...
   $full_marks =  $getExamSchedule->full_marks;
    ...
    $total_mark = $class_work + $home_work + $test_work + $exam;
     ...
     if($full_marks >= $total_mark)
     {
        ...
        $save->exam_id = $request->exam_id;
        $save->class_id = $request->class_id;
        $save->subject_id = $request->subject_id; // Change to get subject_id from $mark
        $save->class_work = $class_work;
        $save->home_work = $home_work;
        $save->test_work = $test_work;
        $save->exam = $exam;
     ...
     {
        $json['message'] = "your total mark grater than full mark";
     }
